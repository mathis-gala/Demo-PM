import { COHERE_EMBED_RES } from "./cohere-embed";

export const COHERE_EMBED_RES_NO_ORPHANS = {
  time: 1300,
  name: "Cohere Embed Only Desc No Orphans",
  origin: COHERE_EMBED_RES,
  results: [
    {
      idea: {
        id: "idea-1",
